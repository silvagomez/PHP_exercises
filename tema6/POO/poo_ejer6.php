...
abstract class Operacion { // colocar la palabra abstract por que no queremos instanciar la clase, no se debe colocar public porque da error
  ...
  public final function visualizar() //Método final ninguna subclase puede sobreescribir dicho método.
  {
    echo $this->resultado.'<br>';
  }
}

final class Suma extends Operacion{ // Clase final no se puede heredar.
