...
-- Tiempo de generación: 05-02-2019 a las 07:23:43
...
--
-- Estructura de tabla para la tabla `trenes_nuevos`
--

DROP TABLE IF EXISTS `trenes_nuevos`;
CREATE TABLE IF NOT EXISTS `trenes_nuevos` (
...
--
-- Volcado de datos para la tabla `trenes_nuevos`
--

INSERT INTO `trenes_nuevos` (`numero`, `fecha_compra`, `km_recorridos`) VALUES
(8, '2018-12-18', 400);
